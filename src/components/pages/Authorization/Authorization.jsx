...
import Github from "../../assets/Images/LoginGithub.png";
import Google from "../../assets/Images/LoginGoogle.png";
import Linked from "../../assets/Images/LoginLinkedIn.png";
import Microsoft from "../../assets/Images/LoginMicrosoft.png";
  ...
  return (
    <div className="app__container">
      ...
      <div className="subtitle">
        ...
        <Link className="subtitle__link" to="/2">
          Signup
        </Link>
      </div>
